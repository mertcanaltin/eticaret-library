...
<?php $Sorgu = Sorgu("SELECT * FROM urunler WHERE durum = '1' and adi like '%$kelime%'");
			 if(!mysql_affected_rows()){?>
				   <div class="alert alert-warning">
                   <strong><?php echo $kelime;?></strong> aramasına ait ürün bulunamadı..
			  ...
			  while($Sonuc = Sonuc($Sorgu)){?>
				...
				<div class="box-images">
					<a href="urun-detay-<?php echo $Sonuc->seo;?>.html" title="" class="product-image"><img src="uploads/urunler/<?php echo $Sonuc->resim;?>" width="270" height="270" alt="" /></a>
				</div>
				...
				<?php echo $Sonuc->yeni == 'Evet' ? '<span class="icon-new">Yeni</span>	' : null; ?>
									...
									<ul class="add-to-links">
																					<li><p><button type="button" title="Sepete Ekle" class="button btn-cart" onclick="setLocation('urun-detay-<?php echo $Sonuc->seo;?>.html')"><span><span><i class="fa fa-shopping-cart" style="font-size: 16px; vertical-align:middle;"></i></span></span></button></p></li>
																																		<li><a href="?kekle=<?php echo $Sonuc->id;?>" class="link-compare"><i class="fa fa-compress"></i></a></li>
																																		<li><a href="urun-detay-<?php echo $Sonuc->seo;?>.html" class="link-wishlist"><i class="fa fa-heart"></i></a></li>
																			
					</ul>
								<div class="product-shop1">
												<h2 class="product-name"><a href="urun-detay-<?php echo $Sonuc->seo;?>.html" title="<?php echo $Sonuc->adi;?>"><?php echo $Sonuc->adi;?></a></h2>
													    <div class="ratings">
					...
					<?php $YorumVarmi = Sonuc(Sorgu("SELECT * FROM urun_yorum WHERE durum = '1' AND urun_id = '$Sonuc->id'"));?>
											<?php if($YorumVarmi > 0){?>
												<?php $YSorgu = Sorgu("SELECT * FROM urun_yorum WHERE durum = '1' AND urun_id = '$Sonuc->id' ORDER BY id DESC");
												$ytoplam = 0;
												$ysay = 0;
    ...
    <div class="price-box">
                ...
                <span class="price" id="product-price-17">
                   <?php echo number_format($Sonuc->ifiyat, 2, ',', '.'); ?>   ₺             </span>
                </p>
                        <p class="old-price">
                <span class="price-label">Eski Fiyatı:</span>
                <span class="price" id="old-price-17">
                   <?php echo number_format($Sonuc->fiyat, 2, ',', '.'); ?>  ₺              </span>
            </p>
        <?php }elseif($Sonuc->indirim == "0"){?>	
                  <p class="special-price">
