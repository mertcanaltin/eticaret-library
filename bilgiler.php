...
<div class="toolbar">
        ...
        <div class="sort-by">
            <label>BİLGİLENDİRME SAYFALARI</label>
 ...
 ?>   
    ...
    <div class="row">
        <div class="col-sm-5 col-md-5 col-sms-6 col-smb-12">
            <img width="" height="" alt="blog" src="images/etic.jpg">        </div>
        <div class="col-sm-7 col-md-7 col-sms-7 col-smb-12">
        <div class="postTitle">
            <h2><a href="bilgi-detay-<?php echo $haberSonuc->seo;?>.html"><?php echo $haberSonuc->adi;?></a></h2>
            <h3><?php echo $haberSonuc->tarih;?></h3>
        </div>
        <div class="postContent"><p><?php echo substr($haberSonuc->aciklama,0,260);?> </p><a class="aw-blog-read-more" href="bilgi-detay-<?php echo $haberSonuc->seo;?>.html">Devamı</a></div>
