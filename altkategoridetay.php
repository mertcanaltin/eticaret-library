<?php include("header2.php");?>  
        <?php $id = g('id');?>
<?php $sayfa = Sonuc(Sorgu("SELECT * FROM alt_urun_kategori WHERE seo = '$id'"));?>
...
<div class="bx-title">
    ...
    <div class="category-products">
                ...
                <ol class="products-list" id="products-list">
					       ...
					       <?php $USorgu = Sorgu("SELECT * FROM urunler WHERE durum = '1' AND altkategori = '$sayfa->id' ORDER BY tarih DESC");
