    ...
    <div class="toolbar">
        ...
        <div class="sort-by">
            ...
            <select onchange="setLocation(this.value)">
                            <option value="firsat-urunleri.html" selected="selected">
                    Seçiniz                </option>
                            <option value="enyenifirsat-urunler.html">
                   Önce En Yeni Ürünler              </option>
                            <option value="enyuksekfirsat-urunler.html">
    ...
    <div class="pager">
        <!--<p class="amount">
                            ...
                            <ul class="products-grid row last even">
								       <?php $USorgu = Sorgu("SELECT * FROM urunler WHERE durum = '1' AND sicak = 'Evet' ORDER BY fiyat DESC");
				...
				</div>	<?php echo $USonuc->cok == 'Evet' ? '<span class="icon-sale">Popüler</span>	' : null; ?>
